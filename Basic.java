...
class Basic extends JFrame implements ActionListener
{
	...
	JLabel l1,l2,l3,l4,l5,l8,l9,l10,l11, l12,ls;
	JTextField tb1,tb2,tb3,tb4,tb5,tb9,tb10,tb11,ts,tb12,tb13,tb14,tb15;
	...
	public void actionPerformed(ActionEvent ae)
	{
		...
		if(ae.getSource()==b1)
		{
			try
			{
				...
				if(tb1.getText().equals("") || tb2.getText().equals("")|| tb3.getText().equals("") || tb4.getText().equals("") || tb5.getText().equals("") || tb10.getText().equals("") ||tb11.getText().equals("")  || tb12.getText().equals("")  || tb13.getText().equals("") || tb14.getText().equals("") || tb15.getText().equals("") || ta1.getText().equals("") || ta2.getText().equals(""))
					{
				...
				if(temp==0)
				{
					...
					stmt1.setString(6,s8);
					stmt1.setString(7,s9);
					stmt1.setString(8,s10);
					stmt1.setString(9,s11);
					stmt1.setString(10,s12);
					stmt1.setString(11,s13);
					stmt1.setString(12,s14);
					stmt1.setString(13,s15);
					stmt1.setString(14,s16);
					stmt1.setString(15,s17);
					stmt1.setString(16,s18);
					stmt1.setString(17,s19);
			...
			{
			JOptionPane.showMessageDialog(f1,"DATABASE PROBLEM");
			}
		}
		...
		else if(ae.getSource()==b3)
		{
			...
			{
				connect();
				String sql="update studentpersonal set Rollno=?,Stuname=?,Birthdate=?,Fathername=?,Mothername=?,Preaddress=?,Paraddress=?,Teleno=?,Mobino=?,Emailid=?,Foccu=?,Gender=?,Moccu=?,Class=?,Marksheet=?,Scc=?,Cc=? where Rollno='"+s1+"'";
				...
				pstmt1.setString(6,s8);
				pstmt1.setString(7,s9);
				pstmt1.setString(8,s10);
				pstmt1.setString(9,s11);
				pstmt1.setString(10,s12);
				pstmt1.setString(11,s13);
				pstmt1.setString(12,s14);
				pstmt1.setString(13,s15);
				pstmt1.setString(14,s16);
				pstmt1.setString(15,s17);
				pstmt1.setString(16,s18);
				pstmt1.setString(17,s19);
			...
			try
			{
				...
				while(rs1.next())
				{
					if(s20.equals(rs1.getString(1)))
					{
						...
						ta1.setText(rs1.getString(6));
						ta2.setText(rs1.getString(7));
						tb10.setText(rs1.getString(8));
						tb11.setText(rs1.getString(9));
						tb12.setText(rs1.getString(10));
						jcb1.setSelectedItem(rs1.getString(11));
						jcb5.setSelectedItem(rs1.getString(12));
						jcb2.setSelectedItem(rs1.getString(13));
						jcb3.setSelectedItem(rs1.getString(14));

						tb13.setText(rs1.getString(15));
						tb14.setText(rs1.getString(16));
						tb15.setText(rs1.getString(17));
						break;
					}
					flag=0;
				}
...
{
Basic bi=new Basic("sims");
bi.setVisible(true);
bi.setSize(1000,1000);
}
}
